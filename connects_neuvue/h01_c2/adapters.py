...
auto_proof_graph_dtype = adapters.FilePathAdapter("filepath@auto_proof_graph")
auto_proof_decomposition_dtype = adapters.FilePathAdapter('filepath@auto_proof_decomposition')
